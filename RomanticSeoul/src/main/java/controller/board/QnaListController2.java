...
@Controller
public class QnaListController2 extends SuperClass {
	private final String command = "/adminBoList.bo" ; 
	private ModelAndView mav = null ;
	private String redirect = "redirect:/adminBoList.bo" ;
	
	@Autowired
	@Qualifier("bdao")
	private BoardDao dao ;
	
	public QnaListController2() {
		super("adminBoList", null);
