...
@Controller
public class MeBoListController extends SuperClass{
	private final String command = "/meBoList.me" ; 
	private ModelAndView mav = null ;
	private String redirect = "redirect:/meBoList.me" ;
	
	@Autowired
	@Qualifier("mdao")
	private MemberDao dao ;
	
	public MeBoListController() {
		super("meBoList.me", null);
